...
Rails.application.routes.draw do
  ...
  def add_swagger_route http_method, path, opts = {}
    ...
    match full_path, to: "topological_inventory/api/#{opts.fetch(:controller_name)}##{opts[:action_name]}", via: http_method
  end
  ...
  add_swagger_route 'GET', '/Fryguy/topological_inventory/0.0.1/container_projects', controller_name: 'users', action_name: 'list_container_projects'
  add_swagger_route 'GET', '/Fryguy/topological_inventory/0.0.1/container_groups', controller_name: 'users', action_name: 'list_container_groups'
