RSpec.shared_examples "v2x0_test_index_and_subcollections" do |primary_collection, subcollections|
  let(:collection_path) { "/api/v2.0/#{primary_collection}" }

  describe("/api/v2.0/#{primary_collection}") do
    context "get" do
  ...
  describe("/api/v2.0/#{primary_collection}/:id") do
  ...
  describe("subcollections") do
    subcollections.each do |subcollection|
      describe("/api/v2.0/#{primary_collection}/:id/#{subcollection.to_s}") do
