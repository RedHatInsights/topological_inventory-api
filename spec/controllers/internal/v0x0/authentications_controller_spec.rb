RSpec.describe Internal::V0x0::AuthenticationsController, :type => :request do
  ...
  it "GET an instance" do
    get(internal_v0x0_authentication_url(authentication.id), :headers => headers)
  ...
  it "GET an instance exposing password" do
    get(internal_v0x0_authentication_url(authentication.id), :params => {"expose_encrypted_attribute[]" => "password"}, :headers => headers)
